...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "constructed_responses_user_id_idx" ON "constructed_responses" ("user_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "notes_page_slug_idx" ON "notes" ("page_slug");--> statement-breakpoint

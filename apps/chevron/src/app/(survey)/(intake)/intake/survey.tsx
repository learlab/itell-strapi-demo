...
import surveyData from './intake-survey-schema.json';
...
const instructionScreens: Record<string, InstructionScreen> = {
  start: {
    id: 'start',
    type: 'instruction',
    content: 'Now, please tell us a little bit about yourself, and your access to technologies and the internet.'
  },
  end: {
    id: 'end',
    type: 'instruction',
    content: 'Thank you for filling out the survey!'
  }
};

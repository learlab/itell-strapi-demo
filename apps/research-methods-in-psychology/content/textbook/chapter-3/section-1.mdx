...
page_slug: 15-moral-foundations-of-ethical-research
summary: true
quiz: false
reference_summary: This section outlines a framework for addressing ethical issues in psychological research, emphasizing four key moral principles: weighing risks against benefits, acting responsibly and with integrity, seeking justice, and respecting individuals' rights and dignity. Ethical conflicts often arise, particularly when research poses risks to participants while benefiting the scientific community or society. Notable examples, such as Milgram's obedience study and the Tuskegee syphilis study, illustrate the complexities of informed consent and the importance of ethical considerations. Researchers must navigate these conflicts thoughtfully, ensuring that ethical standards guide their work while minimizing harm and maximizing benefits.
---
<section className="content-chunk" aria-labelledby="Learning-Objectives-244pt" data-subsection-id="Learning-Objectives-244pt" data-show-header="false">

<h2 className="sr-only" id="Learning-Objectives-244pt">Learning Objectives</h2>
...
<section className="content-chunk" aria-labelledby="A-Framework-for-Thinking-About-Research-Ethics-870t" data-subsection-id="A-Framework-for-Thinking-About-Research-Ethics-870t" data-show-header="true">

## A Framework for Thinking About Research Ethics \{#A-Framework-for-Thinking-About-Research-Ethics-870t}

Table 3.1 presents a framework for thinking through the ethical issues involved in psychological research. The rows ofTable 3.1 represent four general moral principles that apply to scientific research: weighing risks against benefits, acting responsibly and with integrity, seeking justice, and respecting people’s rights and dignity. (These principles are adapted from those in the American Psychological Association \[APA\] Ethics Code.) The columns ofTable 3.1 represent three groups of people that are affected by scientific research: the research participants, the scientific community, and society more generally. The idea is that a thorough consideration of the ethics of any research project must take into account how each of the four moral principles applies to each of the three groups of people.

Table 3.1A Framework for Thinking About Ethical Issues in Scientific Research
...
<section className="content-chunk" aria-labelledby="Moral-Principles-871t" data-subsection-id="Moral-Principles-871t" data-show-header="true">
...
<section className="content-chunk" aria-labelledby="Moral-Principles-872t" data-subsection-id="Moral-Principles-872t" data-show-header="false">

<h2 className="sr-only" id="Moral-Principles-872t">Moral Principles</h2>
...
<section className="content-chunk" aria-labelledby="References-245pt" data-subsection-id="References-245pt" data-show-header="true">

...
page_slug: 4-science-and-common-sense
summary: true
quiz: false
reference_summary: This section emphasizes the limitations of common sense and folk psychology in understanding human behavior, highlighting that many intuitive beliefs are inaccurate. For instance, the notion that "letting out" anger alleviates it is contradicted by research. The text also discusses several myths, such as the belief that people only use 10% of their brains. Psychologists advocate for skepticism, which involves questioning claims and seeking empirical evidence rather than accepting intuitive beliefs. Acknowledging uncertainty is crucial, as many claims lack sufficient evidence. This approach fosters critical thinking and scientific inquiry in psychology.
---
<section className="content-chunk" aria-labelledby="Learning-Objectives-220pt" data-subsection-id="Learning-Objectives-220pt" data-show-header="false">

<h2 className="sr-only" id="Learning-Objectives-220pt">Learning Objectives</h2>

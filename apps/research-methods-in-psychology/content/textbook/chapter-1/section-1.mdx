...
page_slug: 1-methods-of-knowing
summary: true
quiz: false
reference_summary: The page outlines five methods of acquiring knowledge: intuition, authority, rationalism, empiricism, and the scientific method. Intuition relies on gut feelings but can be biased. Authority involves accepting information from figures like parents or experts, which can be misleading. Rationalism uses logic to draw conclusions, but flawed premises can lead to errors. Empiricism is based on observation and experience, yet our senses can deceive us. The scientific method combines systematic observation and rational thought, making it the most reliable method, though it has limitations in feasibility and scope. Understanding these methods is crucial for evaluating knowledge in psychology.
---
<section className="content-chunk" aria-labelledby="Learning-Objectives-198pt" data-subsection-id="Learning-Objectives-198pt" data-show-header="false">

<h2 className="sr-only" id="Learning-Objectives-198pt">Learning Objectives</h2>

<Info title="Learning Objectives">
1\. Describe the 5 methods of acquiring knowledge.

2\. Understandthe benefits and problems with each.
</Info>
...
<section className="content-chunk" aria-labelledby="Intuition-752t" data-subsection-id="Intuition-752t" data-show-header="false">

<h2 className="sr-only" id="Intuition-752t">Intuition</h2>
...
<section className="content-chunk" aria-labelledby="Rationalism-754t" data-subsection-id="Rationalism-754t" data-show-header="false">

<h2 className="sr-only" id="Rationalism-754t">Rationalism</h2>
...
<section className="content-chunk" aria-labelledby="References-199pt" data-subsection-id="References-199pt" data-show-header="true">

  ...
  (
    ...
    return (
      <div className="relative">
        ...
        {pending ? (
          <div className="absolute bottom-0 left-0 right-0 top-0 z-50 cursor-not-allowed gap-2 bg-background/80 backdrop-blur-sm transition-all duration-100 animate-in animate-out">

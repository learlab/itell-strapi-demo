		...
		<div className="block md:hidden">
			...
			{showMobileMenu && (
				<div
					ref={ref}
					className={cn(
						"fixed inset-0 top-16 z-50 grid h-fit bg-background grid-flow-row auto-rows-max overflow-auto  shadow-md animate-in slide-in-from-bottom-80 md:hidden",
					)}
				>
...
const TopLink = ({
	...
	text,
	active,
}: { href: string; text: string; active: boolean }) => {
	return (
		<Link
			href={href}
			className={cn(

...
title: Tort Reform
---
<div className="content-chunk" data-subsection-id = "Learning-Objectives-248t">
<info title="LEARNING OBJECTIVES">1. See why tort reform is advocated, why it is opposed, and what interests take each side. 2. Understand some of the significant state reforms in the last two decades. 3. Know what federal reforms have been instituted.</info>
</div>
...
<div className="content-chunk" data-subsection-id = "Exercises-257t">
<callout>1. Why is it so difficult to determine if there really is a “tort crisis” in the United States? 2. What reforms have been made to state tort law? 3. What federal legislation affects consumer safety?</callout>
</div>

...
<Info title="LEARNING OBJECTIVES">1\. Recognize a UCC express warranty and how it is created. 2. Understand what is meant under the UCC by implied warranties, and know the main types of implied warranties: merchantability, fitness for a particular purpose, and title. 3. Know that there are other warranties: against infringement and as may arise from usage of the trade. 4. See that there are difficulties with warranty theory as a cause of action for products liability; a federal law has addressed some of these.</Info>

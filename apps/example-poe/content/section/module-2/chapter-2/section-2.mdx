...
<info title="LEARNING OBJECTIVES">1. Understand that contract law comes from two sources: judges (cases) and legislation. 2. Know what the Restatement of Contracts is. 3. Recognize the Convention on Contracts for the International Sale of Goods.</info>
...
<div className="content-chunk" data-subsection-id = "Statutory-Law:-The-Uniform-Commercial-Code-32t">
...
<div className="content-chunk" data-subsection-id = "Organization-of-the-UCC-31t">

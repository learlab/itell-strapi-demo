...
title: "The offer"
---
<div className="content-chunk" data-subsection-id = "Introduction-59t">
<info title="Learning Objectives">- Know the definition of offer. - Recognize that some proposals are not offers. - Understand the three essentials of an offer: intent, communication, and definiteness. - Know when an offer expires and can no longer be accepted.</info>
...
<div className="content-chunk" data-subsection-id = "The-Definition-of-Offer-62t">
...
<div className="content-chunk" data-subsection-id = "Proposals-That-Are-Not-Offers-63t">
### Advertisements
...
Although advertisements, price quotations, and the like are generally not offers, the facts in each case are important. Under the proper circumstances, an advertised statement can be construed as an offer, as shown in the well-known __Lefkowitz__ case ([Section 9.4.2 "Advertisements as Offers"](https://saylordotorg.github.io/text_business-law-and-the-legal-environment-v1.0-a/mayer_1.0-ch09_s04#mayer_1.0-ch09_s04_s02) at the end of the chapter), in which the offended customer acted as his own lawyer and pursued an appeal to the Minnesota Supreme Court against a Minneapolis department store that took back its advertised offer.
...
<div className="content-chunk" data-subsection-id = "Communication-66t">
...
<div className="content-chunk" data-subsection-id = "Definiteness-65t">
...
<div className="content-chunk" data-subsection-id = "The-UCC-Approach-64t">
...
<div className="content-chunk" data-subsection-id = "Duration-of-Offer-67t">
...
The death or insanity of the offeror prior to acceptance terminates the offer; the offer is said to die with the offeror. (Notice, however, that the death of a party to a __contract__ does not necessarily terminate the contract: the estate of a deceased person may be liable on a contract made by the person before death.)
...
<warning title="Exercises">.1 Why is it said an offer is a “manifestation” of willingness to enter into a contract? How could willingness be “manifested”? 2. Which kind of standard is used to determine whether a person has made an offer—subjective or objective? 3. If Sandra posts a written notice offering “to the kitchen staff at Coldwater Bay (Alaska) transportation to Seattle at the end of the fishing season,” and if David, one of the maintenance workers, says to her, “I accept your offer of transportation to Seattle,” is there a contract? 4. What are the seven ways an offer can terminate?</warning>
</div>

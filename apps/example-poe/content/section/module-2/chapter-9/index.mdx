---
title: " The Agreement"
page_slug: the-agreement-1
summary: false
quiz: false
---
<div className="content-chunk" data-subsection-id = "The-Agreement-294t">
<Info title="Learning Objectives">After reading this chapter, you should understand the following: - What a contract offer is, and what proposals are not offers  
\- How an offer is communicated  
\- How definite the offer needs to be  
\- How long an offer is good for  
\- How an offer is accepted, who can accept it, and when acceptance is effective</Info>

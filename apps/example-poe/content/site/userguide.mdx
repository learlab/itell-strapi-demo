...
This document provides guidelines for using iTELL. As a test case, we cover the iTELL adaptation of Business Law and the Legal Environment. The textbook was redesigned into an interactive web version by a team comprising a subject matter expert, a content and assessment developer, a multimedia and web developer, and an instructional designer from Georgia Tech.

#### Acknowledgements

We would like to thank [the authors and contributors of the original textbook](https://saylordotorg.github.io/text_business-law-and-the-legal-environment-v1.0-a/index.html). We also appreciate Affordable Learning Georgia, the National Science Foundation, and The National AI Institute for Adult Learning and Online Education (AI-ALOE) for providing funds to support this project.

### 1. Getting Started

#### Access the App

Use the url ([https://itell-strapi-demo.vercel.app/](https://itell-strapi-demo.vercel.app/)) to access the web app.

...
You will be directed to a quiz section after submitting your summary for the final page in each Chapter. Answer each quiz by checking all correct options using the checkboxes (**2**) and clicking on the Next button (**3**). Your progress will be shown on the panel (**1**). Finish answering all quiz items to unlock the next Chapter.

<Image src="/images/userguide/userguide_quiz.png">
  Summaries that do not receive a passing grade will be given detailed feedback.
</Image>

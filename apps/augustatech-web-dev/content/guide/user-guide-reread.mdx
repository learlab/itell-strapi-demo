...
This document provides guidelines for using Intelligent Text for Enhanced Lifelong Learning (iTELL) for Augusta Technical College users. We cover the iTELL adaptation of Eloquent Javascript. The textbook was redesigned into an interactive web version by a team comprising a content and assessment developers, and a multimedia and web developer.

#### Acknowledgements

We would like to thank [the authors and contributors of the original textbook](https://eloquentjavascript.net/). We also appreciate Affordable Learning Georgia, the National Science Foundation, and The National AI Institute for Adult Learning and Online Education (AI-ALOE) for providing funds to support this project.

### 1. Getting Started

#### Surveys

*BEFORE* you start using iTELL, make sure that you have completed your intake survey and have been explicitly redirected to this iTELL volume. 

You are also asked to complete an outtake survey *AFTER* you FINISH using iTELL.
...
Use the url ([https://itell-augustatech-web-dev.vercel.app/](https://itell-augustatech-web-dev.vercel.app/)) to access the web app.

#### Sign in

You will be asked to login using your school email (Outlook):
...
2. You can use your school email to login

<Image
  src="/images/userguide/userguide_augtech_1.png"
>
  Sign in with your Augustatech Outlook account.
...
The textbook's contents are divided into Chapters and Pages. You can access different Chapters and Pages using the left-side navigation bar.
...
iTELL collects usage data to conduct research and update its AI features. All data are only used internally with open-source large language models, and all data is anonymized prior to conducting research.

**Login information**
If you have logged in to iTELL using the single sign on services (e.g., Google or Outlook), iTELL will collect account information required for login authentication (name and email address).

**Usage data**
iTELL collects clickstream data including clicks, scrolls, interaction with different features and elements within iTELL (e.g., clicking chunk reveal buttons or changing view settings in the dashboard), as well as keystroke logs when writing summaries,
...
The current version of iTELL AI is built using Meta's Llama 3, a state-of-the-art generative large language model. We use a diverse set of prompts and retrieval augmented generation to dynamically create contextual information best-suited for generating accurate information for a user queries. Read more about Llama 3's architecture and performance [here](https://ai.meta.com/blog/meta-llama-3/). and more about Llama 3's license information [here](https://llama.meta.com/llama3/license/). 

...
<Sandbox pageSlug="values-types-and-operators" code={`console.log(typeof 4.5)
// → number
...
<Sandbox pageSlug="values-types-and-operators" code={`console.log(8 * null)
// → 0
console.log("5" - 1)
// → 4
console.log("5" + 1)
...
<Sandbox pageSlug="values-types-and-operators" code={`console.log(null || "user")
// → user

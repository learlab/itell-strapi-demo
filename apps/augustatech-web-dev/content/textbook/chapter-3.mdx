...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let listOfNumbers = [2, 3, 5, 7, 11];
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let doh = "Doh";
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let sequence = [1, 2, 3];
sequence.push(4);
sequence.push(5);
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let day1 = {
  squirrel: false,
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let anObject = {left: 1, right: 2};
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`console.log(Object.keys({x: 0, y: 0, z: 2}));
// → ["x", "y", "z"]`}/>

There’s an `Object.assign` function that copies all properties from one object into another:

<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let objectA = {a: 1, b: 2};
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let journal = [
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let object1 = {value: 10};
let object2 = object1;
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`const score = {visitors: 0, home: 0};
// This is okay
score.visitors = 1;
// This isn't allowed
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`addEntry(["work", "touched tree", "pizza", "running",
          "television"], false);
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function phi(table) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`var JOURNAL
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function tableFor(event, journal) {
  let table = [0, 0, 0, 0];
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`for (let entry of JOURNAL) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function journalEvents(journal) {
  let events = [];
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`for (let event of journalEvents(JOURNAL)) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let todoList = [];
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`console.log([1, 2, 3, 2, 1].indexOf(2));
// → 1
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`console.log([0, 1, 2, 3, 4].slice(2, 4));
// → [2, 3]
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function remove(array, index) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let kim = "Kim";
kim.age = 88;
console.log(kim.age);
// → undefined`}/>
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`console.log("coconuts".slice(4, 7));
// → nut
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let sentence = "Secretarybirds specialize in stomping";
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let string = "abc";
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function max(...numbers) {
  let result = -Infinity;
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let numbers = [5, 1, 7];
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function randomPointOnCircle(radius) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`console.log(Math.random());
// → 0.36993729369714856
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function phi([n00, n01, n10, n11]) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let {name} = {name: "Faraji", age: 23};
console.log(name);`}/>
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`function city(object) {
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`let string = JSON.stringify({squirrel: false,
                             events: ["weekend"]});
console.log(string);
...
<Sandbox pageSlug="4-data-structures-objects-and-arrays" code={`// Your code here.

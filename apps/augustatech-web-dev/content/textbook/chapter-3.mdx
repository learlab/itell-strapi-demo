...
```javascript /"touched tree"/#v caption="quotes are required for invalid binding names when creating objects"
let descriptions = {
 work: "Went to work",
...
```javascript /...words/#v caption="use the spread operator to concatenate arrays"
...
```javascript /...coordinates/#v caption="use the spread operator to merge objects"

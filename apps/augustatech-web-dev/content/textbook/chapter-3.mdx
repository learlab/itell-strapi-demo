...
If we call that table $_n$_, we can compute $\\phi_$_ using the following formula:

$$

\\phi = \\frac{n_{11}n_{00} - n_{10}n_{01}}{\\sqrt{(n_{1•} + n_{0•})(n_{•1} + n_{•0})(n_{1•} + n_{•1})(n_{0•} + n_{•0})}}

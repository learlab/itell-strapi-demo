...
```javascript {2}#a {9}#b caption="a function can take 0 parameters or multiple parameters"
// 0 parameters
...
```javascript caption="the ingredient function is defined inside the hummus function, capturing the factor binding of the hummus function"
...
```javascript caption="an arrow function definition"

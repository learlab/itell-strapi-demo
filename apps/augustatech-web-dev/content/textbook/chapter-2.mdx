...
```javascript caption="let and const bindings are local to the block in which they are declared, whereas var variables created outside of functions are global"
let x = 10;   // global
if (true) {

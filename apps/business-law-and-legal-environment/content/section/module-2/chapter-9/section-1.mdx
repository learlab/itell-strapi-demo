...
page_slug: the-agreement-in-general
summary: true
quiz: false
---
<div className="content-chunk" data-subsection-id = "Learning-Objectives-39pt">
<Info title="Learning Objectives">\- Recognize that not all agreements or promises are contracts.  
\- Understand that whether a contract exists is based on an objective analysis of the parties’ interaction, not on a subjective one.</Info>
</div>
...
__Lucy v. Zehmer__  illustrates that a party’s real state of mind must be expressed to the other party, rather than in an aside to one’s spouse.
</div>

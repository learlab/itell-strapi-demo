...
This document provides guidelines for using iTELL. As a test case, we cover the iTELL adaptation of the Handbook of Learning Analytics. The textbook was redesigned into an interactive web version by a team comprising a subject matter expert, a content and assessment developer, a multimedia and web developer, and an instructional designer from Georgia Tech.
...
- Each chapter will have one quiz section.
...
- For this textbook, there will be constructed response items or summary items that are **NOT** scored by the AI engine. In this case, your response will simply be accepted by the system, and you will be notified with a phrase such as "Your answer was accepted"

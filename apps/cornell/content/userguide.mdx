...
This document provides guidelines for using iTELL. We cover the iTELL adaptation of the Handbook of Learning Analytics. The textbook was redesigned into an interactive web version by a team comprising content and assessment developers, multimedia and web developers, and learning engineers.

#### Acknowledgements

We would like to thank [the authors and contributors of the original textbook](https://www.solaresearch.org/publications/hla-22/). We also appreciate Affordable Learning Georgia, the National Science Foundation, and The National AI Institute for Adult Learning and Online Education (AI-ALOE) for providing funds to support this project.

### 1. Getting Started

#### Surveys

*BEFORE* you start using iTELL, complete the intake survey using the following URL: ([https://peabody.az1.qualtrics.com/jfe/form/SV_4G801fTbGRTUTie](https://peabody.az1.qualtrics.com/jfe/form/SV_4G801fTbGRTUTie))

You are also required to complete an outtake survey *AFTER* you FINISH using iTELL using the following URL: ([https://peabody.az1.qualtrics.com/jfe/form/SV_1FvOUS4qdAKEJy6](https://peabody.az1.qualtrics.com/jfe/form/SV_1FvOUS4qdAKEJy6))

#### Access the App

Use the url ([https://itell-cornell.vercel.app/](https://itell-cornell.vercel.app/)) to access the web app.
...
_Your account needs to be connected to your class_ for you and your instructor to have full access to iTELL's features. Connect your account to your class by following the steps below. You can also use the following link to join your class: [JOIN CLASS](https://itell-cornell.vercel.app/auth?join_class_code=cornell_class)
...
2. Go to the Settings page (**1**). Enter your Class Code (**2**) and click _Join_ (**3**). Your Class Code is **cornell_class**
...
<Image src="/images/userguide/userguide_iTELLAI_1.png">
  iTELL AI's module is located at the bottom right side of the screen
</Image>
...
Answer the question and engage in a conversation with iTELL AI to gain a better understanding of the passage. Once you feel that you have a better understanding of the text, click on the `Return to summary` button to go back to the summary module and rewrite your summary.

<Image src="/images/userguide/userguide_iTELLAI_4.png">
  After responding to iTELL AI's question, you can continue to engage with iTELL AI, or go back to the summary module
</Image>
...
<Image src="/images/userguide/userguide_iTELLAI_5.png">

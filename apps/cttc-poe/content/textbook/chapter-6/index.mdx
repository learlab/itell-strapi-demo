...
In this chapter, you will learn about:   <ul>       <li>Measuring the Size of the Economy: Gross Domestic Product</li>       <li>Adjusting Nominal Values to Real Values</li>       <li>Tracking Real GDP over Time</li>       <li>Comparing GDP among Countries</li>       <li>How Well GDP Measures the Well-Being of Society?</li>   </ul>
</Info>
</div>

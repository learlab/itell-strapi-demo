...
summary: true
quiz: false
reference_summary: The page discusses the concept of real GDP and its importance in measuring economic growth. It explains how GDP growth is reported at an annualized rate and shows the historical pattern of U.S. real GDP since 1930. The page also covers the impact of recessions and depressions on employment, wages, and overall economic activity. It introduces the idea of business cycles, including peaks, troughs, and expansions, and provides a table listing U.S. business cycles since 1900. The page concludes by mentioning the role of the National Bureau of Economic Research in tracking business cycles and the lingering effects of severe recessions.
---
<div className="content-chunk" data-subsection-id = "LEARNING-OBJECTIVES-170pt" show-header = "false">
...
<div className="content-chunk" data-subsection-id = "Tracking-Real-GDP-over-Time-716t" show-header = "false">
...
<div className="content-chunk" data-subsection-id = "Tracking-Real-GDP-over-Time-629t" show-header = "false">

...
summary: true
quiz: false
reference_summary: This section of the textbook discusses how Gross Domestic Product (GDP) is used to compare the economic welfare of different nations. It explains that to compare GDP between countries, it must be converted to a common currency using exchange rates. Additionally, because countries have different population sizes, GDP per capita (GDP divided by population) is used to compare standards of living. The text also provides examples of how to calculate these figures and discusses the differences in GDP and GDP per capita among various countries.
---
<div className="content-chunk" data-subsection-id = "Learning-Objectives-171pt" show-header = "false">
<Info title="LEARNING OBJECTIVES">
By the end of this section, you will be able to: <br/>
<ul> <br/>
<li>Explain how we can use GDP to compare the economic welfare of different nations</li><li>Calculate the conversion of GDP to a common currency by using exchange rates</li><li>Calculate GDP per capita using population data </li> <br/>
</ul>
</Info>
</div>
<div className="content-chunk" data-subsection-id = "Learning-Objectives-658t" show-header = "false">
...
<div className="content-chunk" data-subsection-id = "Converting-Currencies-with-Exchange-Rates-657t" show-header = "true">
...
<div className="content-chunk" data-subsection-id = "WORK-IT-OUT-660t" show-header = "true">
## WORK IT OUT
...
<div className="content-chunk" data-subsection-id = "GDP-Per-Capita-659t" show-header = "true">
## GDP Per Capita

...
\\text{Convert Brazil's GDP into U.S. dollars: } \\\ \\text{Brazil's GDP in U.S. dollars} = \\frac{\\text{Brazil's GDP in reals}}{\\text{Exchange rate (reals/\\$ U.S.)}} = \\frac{7.4 \\text{ trillion reals}}{2.362 \\text{ reals/\\$ U.S.}} = \\$3.1 \\text{ trillion}

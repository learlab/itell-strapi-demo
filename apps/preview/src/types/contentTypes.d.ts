...
export interface ApiApiKeyApiKey extends Schema.CollectionType {
	...
	attributes: {
		...
		Role: Attribute.Enumeration<["developer", "deployment"]> &
			Attribute.Required;
		ApiKey: Attribute.String & Attribute.DefaultTo<"placeholder">;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
...
export interface ApiChapterChapter extends Schema.CollectionType {
	...
	attributes: {
		...
		ChapterNumber: Attribute.Integer;
...
export interface ApiModuleModule extends Schema.CollectionType {
	...
	attributes: {
		Title: Attribute.String;
		Slug: Attribute.UID<"api::module.module", "Title">;
...
export interface ApiPagePage extends Schema.CollectionType {
	...
	attributes: {
		...
		HasSummary: Attribute.Boolean & Attribute.DefaultTo<true>;
		Quiz: Attribute.Relation<"api::page.page", "oneToOne", "api::quiz.quiz">;
		ReferenceSummary: Attribute.Text;
		Chapter: Attribute.Relation<
			"api::page.page",
			"manyToOne",
			"api::chapter.chapter"
		>;
		Volume: Attribute.Relation<"api::page.page", "manyToOne", "api::text.text">;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
...
export interface ApiQuizQuiz extends Schema.CollectionType {
	...
	attributes: {
		PreviousPage: Attribute.Relation<
			"api::quiz.quiz",
			"oneToOne",
			"api::page.page"
		>;
		Questions: Attribute.DynamicZone<["quizzes.multiple-choice-question"]>;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;
...
export interface ApiTextText extends Schema.CollectionType {
	...
	attributes: {
		...
		Description: Attribute.String;
		Slug: Attribute.UID<"api::text.text", "Title">;
		Chapters: Attribute.Relation<
			"api::text.text",
			"oneToMany",
			"api::chapter.chapter"
		...
		Modules: Attribute.Relation<
			...
			"api::module.module"
		>;
		Pages: Attribute.Relation<"api::text.text", "oneToMany", "api::page.page">;
		createdAt: Attribute.DateTime;
		updatedAt: Attribute.DateTime;
		publishedAt: Attribute.DateTime;

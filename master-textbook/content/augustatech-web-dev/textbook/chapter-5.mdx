...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`function speak(line) {
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let finder = {
  find(array) {
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let empty = {};
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`console.log(Object.getPrototypeOf({}) == Object.prototype);
// → true
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`console.log(Object.getPrototypeOf(Math.max) ==
            Function.prototype);
// → true
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let protoRabbit = {
  speak(line) {
    console.log(\`The \${this.type} rabbit says '\${line}'\`);
  }
};
...
```javascript {2,3} caption="create a new class instance and initialize its properties"
...
```javascript /class/#v /constructor/#v /speak/#v caption="define a class with the class keyword"
class Rabbit {
  constructor(type) {
    this.type = type;
  }
...
```javascript {4} caption="define class methods by setting the prototype"
...
```javascript {4} caption="initialize instance properties in the constructor"
class Particle {
  speed = 0;
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let object = new class { getWord() { return "hello"; } };
...
```javascript /#getSecret/#v caption="declare a private method"
...
```javascript /#max/#v caption="declare a private property"
class RandomSource {
  #max;
  constructor(max) {
    this.#max = max;
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`console.log(Array.prototype.toString ==
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`console.log(Object.prototype.toString.call([1, 2]));
// → [object Array]`}/>
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let ages = {
  Boris: 39,
  Liang: 22,
  Júlia: 62
};
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let ages = new Map();
ages.set("Boris", 39);
ages.set("Liang", 22);
ages.set("Júlia", 62);
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`console.log(Object.hasOwn({x: 1}, "x"));
// → true
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`Array.prototype.forEach.call({
  length: 2,
  0: "A",
  1: "B"
}, elt => console.log(elt));
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let varyingSize = {
  get size() {
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`class Temperature {
  constructor(celsius) {
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`const length = Symbol("length");
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let myTrip = {
  length: 2,
  0: "Lankwitz",
  1: "Babelsberg",
  [length]: 21500
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`let okIterator = "OK"[Symbol.iterator]();
...
```javascript {11,14} caption="define a static method and use the this keyword to refer to the class"
class List {
...
```javascript /next()/#v caption="define iteration behavior with the next() method"
class ListIterator {
  constructor(list) {
    this.list = list;
  }
...
```javascript /extends/#v /super/#v caption="use the extends keyword to inherit from another class"
...
```javascript caption="use instanceof to check if an object is an instance of a class"
console.log(
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`// Your code here
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`class Group {
  // Your code here.
}
...
<Sandbox pageSlug="6-the-secret-life-of-objects" code={`// Your code here (and the code from the previous exercise)
